...
impl Engine {
    ...
    pub fn run(&mut self) -> Result<()> {
        ...
        let ys: [f32; 40] = [
            0.50, 0.95, 0.68, 0.55, 0.00, 0.82, 0.13, 0.85, 0.40, 0.60, 0.25, 0.09, 0.89, 0.05,
            0.27, 0.22, 0.20, 0.04, 0.44, 0.74, 0.14, 0.65, 0.03, 0.48, 0.07, 0.45, 0.62, 0.23,
        ...
        for i in 0..40 {
            GameObject::builder(self)
                ...
                .mesh(m.clone())
                .transform(Transform {
                    translation: [xs[i] * 4. - 2., ys[i] * 4. - 2., ys[(i + 20) % 40] * 5.].into(),
                    scale: Vector3::one(),
